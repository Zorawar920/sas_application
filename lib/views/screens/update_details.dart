...
class UpdateDetails extends StatelessWidget {
  ...
  const UpdateDetails({Key? key, required this.codeflag, required this.initialDetails}) : super(key: key);
...
class UpdateDetailsScreen extends StatefulWidget {
  ...
  UpdateDetailsScreen( {required this.updateDetailsViewModel, required this.codeflag, required this.initialDetails});
...
class _UpdateDetailsScreenState extends State<UpdateDetailsScreen> {
  ...
  Widget buildBackButton() {
   ...
   for(var detail in details){
     ...
     phoneNumberController.text = detail['Phone'].toString().substring(detail['Phone'].toString().length-10);
     code = detail['Phone'].toString().substring(0,detail['Phone'].toString().length-10);
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: (value) {
                                      return widget.updateDetailsViewModel.validateName(value!);
                                    },
                                    //Name validator
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: IntlPhoneField(
                                    initialCountryCode: widget.codeflag,
                                    decoration: InputDecoration(
                                      border: InputBorder.none,
                                      errorStyle: errorStyle,
                                      contentPadding:
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      if (globalFormKey.currentState!.validate()) {
                                        if (widget.updateDetailsViewModel.auth.isPhoneVerified == true) {
                                           widget.updateDetailsViewModel
                                              .updateUser(details, this.context);
                                        }
                                        else if (isphoneVerified == true) {
